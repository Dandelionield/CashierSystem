...
public class vision extends JFrame {
	...
	public vision(String code) {
		...
		ventas = new JLabel("");
		ventas.setBorder(new TitledBorder(null, ven[theme], TitledBorder.LEADING, TitledBorder.TOP, null, color[theme]));
		...
		scrolldescripcion.setViewportBorder(new TitledBorder(null, des[theme], TitledBorder.LEADING, TitledBorder.TOP, null, color[theme]));
		...
		txtunidad = new JLabel(lenguaje?"Unidad: ":"Brand: ");
	...
	public void fill(String code) {
		...
		Archivo prod=invMecanics.muestra(code);
