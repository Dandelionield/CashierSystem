...
public class Inventario extends IFrame {
	...
	public Inventario(String user,String userName) {
		...
		userLogo.setIcon(new ImageIcon(new ImageIcon("./src/ResourcePackCaja/UsuarioLight.png").getImage().getScaledInstance(userLogo.getWidth(), userLogo.getHeight(), Image.SCALE_SMOOTH)));
		...
		Logo.setIcon(new ImageIcon(new ImageIcon("./src/ResourcePackCaja/Logo.PNG").getImage().getScaledInstance(Logo.getWidth(), Logo.getHeight(), Image.SCALE_SMOOTH)));
		panel.add(Logo);
		
		JLabel lblActual = new JLabel("");
		lblActual.setBounds(35, 224, 84, 100);
		lblActual.setIcon(new ImageIcon(new ImageIcon("./src/ResourcePackCaja/inva.jpeg").getImage().getScaledInstance(lblActual.getWidth(), lblActual.getHeight(), Image.SCALE_SMOOTH)));
		lblActual.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				Title.setText(lenguaje?"Inventario Actual":"Current Inventory");
				lblActual.setBounds(45, 234, 64, 80);
				lblActual.setIcon(new ImageIcon(new ImageIcon("./src/ResourcePackCaja/inva.jpeg").getImage().getScaledInstance(lblActual.getWidth(), lblActual.getHeight(), Image.SCALE_SMOOTH)));
		...
		lblHistory.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				lblHistory.setBounds(139, 234, 64, 80);
				lblHistory.setIcon(new ImageIcon(new ImageIcon("./src/ResourcePackCaja/invh.jpeg").getImage().getScaledInstance(lblHistory.getWidth(), lblHistory.getHeight(), Image.SCALE_SMOOTH)));
		...
		lblModify.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				lblModify.setBounds(236, 234, 64, 80);
				lblModify.setIcon(new ImageIcon(new ImageIcon("./src/ResourcePackCaja/inv.jpeg").getImage().getScaledInstance(lblModify.getWidth(), lblModify.getHeight(), Image.SCALE_SMOOTH)));
		...
		fondo.setIcon(new ImageIcon(new ImageIcon("./src/ResourcePackCaja/fondo.jpg").getImage().getScaledInstance(fondo.getWidth(), fondo.getHeight(), Image.SCALE_SMOOTH)));
	...
	private void changetheme() {
		...
		if(theme==1) {
			...
			userLogo.setIcon(new ImageIcon(new ImageIcon("./src/ResourcePackCaja/UsuarioDark.png").getImage().getScaledInstance(userLogo.getWidth(), userLogo.getHeight(), Image.SCALE_SMOOTH)));
